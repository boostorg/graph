...
$BOOST_ROOT/b2 ./test/ toolset=$B2_TOOLSET $B2_CXXSTD $COPTS $B2_DEFINES $B2_INCLUDE $LOPTS $B2_TESTFLAGS $B2_ADDRESS_MODEL $B2_LINK $B2_THREADING $B2_VARIANT -j${B2_JOBS} $* 

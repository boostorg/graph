...
namespace boost {
  ...
  namespace detail {
    ...
    { on_no_event_num,
      ...
      on_forward_or_cross_edge_num, on_back_edge_num, on_finish_tree_edge_num, on_finish_edge_num,
  ...
  struct on_finish_tree_edge { enum { num = detail::on_finish_tree_edge_num }; };

...
namespace boost {
  ...
  namespace detail {
    ...
    template <
      ...
      class Vertex>
    class
    matrix_edge_desc_impl : public edge_desc_impl<Directed,Vertex>{
        ...
        >
    {
      ...
      increment(
          ...
          if (m_targ < m_src){ // first half
              ++this->base_reference();
          }else if (m_targ < m_n - 1){ // second half
              ++m_inc;
  ...
  adjacency_matrix_traits {
    ...
    typedef detail::matrix_edge_desc_impl<
      directed_category,
      vertex_descriptor>
    edge_descriptor;
  };
  ...
  struct
  adjacency_matrix_class_tag { };

  struct
  adj_matrix_traversal_tag :
  ...
  class adjacency_matrix {
    ...
    typedef typename lookup_one_property<
      GraphProperty,
      graph_bundle_t>::type
    graph_bundled;
  ...
  public: // should be private
    typedef typename mpl::if_<
      ...
      std::pair<bool, edge_property_type>,
      char>::type
    StoredEdge;
  ...
  public:
    ...
    typedef typename mpl::if_<
      typename Directed::is_directed_t,
      DirOutEdgeIter,
  ...
  edge(
    typename adjacency_matrix<
      ...
      EP,
      GP,
      A>::vertex_descriptor u,
    typename adjacency_matrix<
      D,
      VP,
      EP,
      GP,
      A>::vertex_descriptor v,
  ...
  out_edges(
    ...
    typename Graph::unfiltered_out_edge_iter last(l, u, g.m_vertex_set.size());
    ...
    return std::make_pair(
      out_edge_iterator(pred, first, last),
  ...
  in_edges(
    ...
    typename Graph::unfiltered_in_edge_iter first(f, l, u, g.m_vertex_set.size());
    typename Graph::unfiltered_in_edge_iter last(l, l, u, g.m_vertex_set.size());
    ...
    return std::make_pair(
      in_edge_iterator(pred, first, last),
  ...
  in_edges(
    ...
    typename Graph::unfiltered_in_edge_iter last(l, u, g.m_vertex_set.size());
  ...
  edges(
    ...
    typename Graph::unfiltered_edge_iter last(
      g.m_matrix.end(),
      g.m_matrix.begin(),
      g.m_vertex_set.size());
  ...
  add_edge(
    ...
    typedef typename adjacency_matrix<D,VP,EP,GP,A>::edge_descriptor edge_descriptor;
  ...
  typename adjacency_matrix<D,VP,EP,GP,A>::vertex_descriptor
  add_vertex(
    const VP2& /*vp*/, adjacency_matrix<D,VP,EP,GP,A>& g
  ){
    // UNDER CONSTRUCTION
    BOOST_ASSERT(false);
    return *vertices(g).first;
  ...
  clear_vertex(
    ...
    typename adjacency_matrix<directedS,VP,EP,GP,A>::vertex_iterator vi, vi_end;
  ...
  clear_vertex(
    ...
    typename adjacency_matrix<undirectedS,VP,EP,GP,A>::vertex_iterator vi, vi_end;
  ...
  adj_mat_pm_helper<
    ...
    typedef iterator_property_map<
      typename std::vector<VP>::iterator,
      vi_map_type>
    all_map_type;

    typedef iterator_property_map<
      typename std::vector<VP>::const_iterator,
      vi_map_type>
    all_map_const_type;
    ...
    type
    get_nonconst(
      adjacency_matrix<D, VP, EP, GP, A>& g, Prop prop
    ){
    ...
    edge_property_tag>
  {
    ...
    lookup_property_from_edge {
      ...
      operator()(
        ...
        return lookup_one_property<ep_type_nonref, Tag>::lookup(
          *static_cast<ep_type_nonref*>(e.get_property()),
          tag);
      }
    };
    ...
    typedef function_property_map<
      ...
      typename graph_traits<adjacency_matrix<D, VP, EP, GP, A> >::edge_descriptor>
    type;
    ...
    get_const_one(
      ...
      return lookup_one_property<const EP, Tag>::lookup(
        *static_cast<const EP*>(e.get_property()),
        tag);
    }
  };
  ...
  struct
  property_map<
    adjacency_matrix<D,VP,EP,GP,A>, Tag>
    : adj_mat_pm_helper<
      D,
      VP,
      EP,
  ...
  template <
    ...
    typename A>
  struct
  property_map<adjacency_matrix<D, VP, EP, GP, A>, vertex_index_t>
  {

...
|===
|[#sec:source]#`source(e, g)`# |Returns the vertex descriptor for _u_ of
the edge _(u,v)_ represented by `e`. +
Return type: `vertex_descriptor`

|[#sec:target]#`target(e, g)`# |Returns the vertex descriptor for _v_ of
the edge _(u,v)_ represented by `e`. +
Return type: `vertex_descriptor`

|[#sec:out-edges]#`out_edges(u, g)`# |Returns an iterator-range

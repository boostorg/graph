...
|===
|[#sec:adjacent-vertices]#`adjacent_vertices(v, g)`# |Returns an
...
xref:iterators/adjacency_iterator.adoc[`adjacency_iterator`]
...
xref:iterators/adjacency_iterator.adoc[`adjacency_iterator`] that you can

[#concept:IteratorConstructibleGraph]
...
iterator can be any
http://www.boost.org/sgi/stl/InputIterator.html[InputIterator] that
...
http://www.boost.org/sgi/stl/InputIterator.html[InputIterator] and can

...
http://www.boost.org/sgi/stl/Assignable.html[Assignable], so algorithms
should pass graph objects by reference.
...
Constructible],
http://www.boost.org/sgi/stl/Assignable.html[Assignable], and
http://www.boost.org/sgi/stl/EqualityComparable.html[Equality
Comparable].

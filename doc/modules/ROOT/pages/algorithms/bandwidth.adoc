...
xref:algorithms/cuthill_mckee_ordering.adoc[`cuthill_mckee_ordering`],
xref:algorithms/king_ordering.adoc[`king_ordering`],
xref:algorithms/sloan_ordering.adoc[`sloan_ordering`].

== See Also

* xref:#sec:ith-bandwidth[`ith_bandwidth`]

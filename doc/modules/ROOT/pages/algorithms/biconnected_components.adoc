...
The algorithm implemented is due to Tarjan [xref:about/bibliography.adoc#tarjan72:dfs_and_linear_algo[41]].
...
The file link:../example/biconnected_components.cpp[`examples/biconnected_components.cpp`] contains an example of calculating the biconnected components and articulation points of an undirected graph.

...
link:./cochet-terrasson98numerical.pdf[[1\]].
...
Optimum Cost to Time Ratio Problems] state that this is the most efficient
algorithm to the time being (1999).
...
* link:./cochet-terrasson98numerical.pdf[Cochet-Terrasson et al. -- Numerical computation of spectral elements (1998)]
* link:./dasdan-dac99.pdf[Ali Dasdan, Sandy S. Irani, Rajesh K. Gupta -- Efficient Algorithms for Optimum Cycle Mean and Optimum Cost to Time Ratio Problems (1999)]

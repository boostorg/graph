...
The file link:../example/two_graphs_common_spanning_trees.cpp[`examples/two_graphs_common_spanning_trees.cpp`] contains an example of finding common spanning trees of two undirected graphs.

...
See the test harness `mas_test.cpp` for an example of using maximum adjacency search.

== See Also

* xref:algorithms/stoer_wagner_min_cut.adoc[Stoer-Wagner Min Cut] -- uses maximum adjacency search internally.

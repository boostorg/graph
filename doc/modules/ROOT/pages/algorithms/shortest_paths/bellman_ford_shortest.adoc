...
The Bellman-Ford algorithm [xref:about/bibliography.adoc#bellman58[4],xref:about/bibliography.adoc#ford62:_flows[11],xref:about/bibliography.adoc#lawler76:_comb_opt[20],xref:about/bibliography.adoc#clr90[8]]

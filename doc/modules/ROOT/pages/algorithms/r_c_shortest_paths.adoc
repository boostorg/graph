...
The file link:../example/r_c_shortest_paths_example.cpp[`example/r_c_shortest_paths_example.cpp`] provides examples for how SPPRCs can be solved with the `r_c_shortest_paths` functions. There is an example for an SPP without resource constraints and an example for a shortest path problem with time windows. +

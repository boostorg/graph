...
[source,cpp]
----
include::example$algorithms/traversal/undirected_dfs.cpp[]
----

[,text]
----
include::example$algorithms/traversal/undirected_dfs.txt[]
----
...
| UTIL/OUT | `VertexColorMap vertex_color`
...
template <typename Graph,
          ...
          typename T,
          typename R>
void undirected_dfs(const Graph& g,

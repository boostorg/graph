...
The goal of the Sloan ordering algorithm [xref:about/bibliography.adoc#sloan86[83], xref:about/bibliography.adoc#sloan89[84]] is to reduce the profile and
...
* xref:about/bibliography.adoc#sloan86[[83\]] S. W. Sloan, _An algorithm for profile and wavefront reduction of sparse matrices_, Int. j. numer. methods eng., *23*, 239-251 (1986).
* xref:about/bibliography.adoc#sloan89[[84\]] S. W. Sloan, _A fortran program for profile and wavefront reduction_, Int. j. numer. methods eng., *28*, 2651-2679 (1989).

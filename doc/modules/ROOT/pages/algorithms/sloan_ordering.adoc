...
See link:../../../../example/sloan_ordering.cpp[`example/sloan_ordering.cpp`].
...
[1] S. W. Sloan, _An algorithm for profile and wavefront reduction of sparse
matrices_, Int. j. numer. methods eng., *23*, 239 - 251 (1986)

[2] S. W. Sloan, _A fortran program for profile and wavefront reduction_,

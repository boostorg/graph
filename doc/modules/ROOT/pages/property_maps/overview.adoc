...
All 10 property map types in one file:
...
* xref:property_maps/overview.adoc[Using Property Maps (tutorial)]
* xref:overview/bundles.adoc[Bundled Properties]
* xref:traits/property_map.adoc[property_map trait]
* xref:traits/property.adoc[property template]

...
void test_circle_layout(
    Graph*, typename graph_traits< Graph >::vertices_size_type n)
{
...
template < typename Graph > void test_triangle(Graph*)
{
    ...
    edge_descriptor e2 = add_edge(v, w, g).first;
    put(edge_weight, g, e2, 1.0);
    edge_descriptor e3 = add_edge(w, u, g).first;
...
template < typename Graph > void test_cube(Graph*)
{
    enum
    {
        A,
...
template < typename Graph > void test_triangular(Graph*)
{
    enum
    {
        A,
    ...
    simple_edge triangular_edges[18] = { { A, B }, { A, C }, { B, C }, { B, D },
        { B, E }, { C, E }, { C, F }, { D, E }, { D, G }, { D, H }, { E, F },
        { E, H }, { E, I }, { F, I }, { F, J }, { G, H }, { H, I }, { I, J } };
...
template < typename Graph > void test_disconnected(Graph*)
{
    enum
    {
        A,
    ...
    simple_edge triangular_edges[13] = { { A, B }, { B, C }, { C, A }, { D, E },
        { E, F }, { F, G }, { G, H }, { H, D }, { D, F }, { F, H }, { H, E },
        { E, G }, { G, D } };
...
int test_main(int, char*[])
{
    typedef adjacency_list< listS, listS, undirectedS,
        // Vertex properties
        property< vertex_index_t, int, property< vertex_position_t, point > >,
        // Edge properties

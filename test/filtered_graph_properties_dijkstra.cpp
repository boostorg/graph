...
struct
Evaluator
    : public boost::put_get_helper< int, Derived >
{
        ...
        LengthEvaluator<Graph> >
{
    ...
    typedef typename Evaluator<
        Graph,
        LengthEvaluator<Graph> >::reference
    reference;

    typedef typename Evaluator<
        Graph,
        LengthEvaluator<Graph> >::key_type
    key_type;
...
UndirectedGraph::
dijkstra(
    Evaluator const& rEvaluator,
    Filter const& rFilter
) const{
...
dijkstra(
    ...
    EdgeFilter<UndirectedGraph> const&
) const;

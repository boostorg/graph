...
BOOST_AUTO_TEST_CASE(test_max_attempts)
{
    ...
    std::size_t generated
        = boost::generate_random_points< boost::simple_point< int > >(
            num_points,
...
{
    using BoostGeomPoint = boost::geometry::model::point<double, 2, boost::geometry::cs::cartesian>;

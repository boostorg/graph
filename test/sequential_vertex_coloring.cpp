...
int main(int, char*[])
{
  ...
  BOOST_TEST_EQ(get(color, (vertices_size_type)A), 0);
  BOOST_TEST_EQ(get(color, (vertices_size_type)B), 0);
  BOOST_TEST_EQ(get(color, (vertices_size_type)C), 1);
  BOOST_TEST_EQ(get(color, (vertices_size_type)D), 2);
  BOOST_TEST_EQ(get(color, (vertices_size_type)E), 1);
